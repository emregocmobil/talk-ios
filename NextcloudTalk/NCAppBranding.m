...
NSString * const talkAppName = @"Göç Kırlangıç";
NSString * const filesAppName = @"Göç Kırlangıç";
NSString * const copyright = @"© 2023 GöçKırlangıç";
NSString * const bundleIdentifier = @"tr.goc.gov.kirlangic.Talk";
NSString * const groupIdentifier = @"group.tr.goc.gov.kirlangic.Talk";
NSString * const appsGroupIdentifier = @"group.tr.goc.gov.kirlangic.apps";
NSString * const pushNotificationServer = @"https://bulut.goc.gov.tr";
...
NSString * const brandColorHex = @"#9A0000";
